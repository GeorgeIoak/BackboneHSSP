...
*
* \funcusage
*  \snippet Pin_SWDIO_SUT.c usage_Pin_SWDIO_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_SWDIO_SUT.c usage_Pin_SWDIO_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_SWDIO_SUT.c usage_Pin_SWDIO_Read  
*******************************************************************************/
...
* preferred Pin_SWDIO_Read() API because the 
* Pin_SWDIO_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Pin_SWDIO_SUT.c usage_Pin_SWDIO_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Pin_SWDIO_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Pin_SWDIO_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Pin_SWDIO_0_INTR       (First pin in the list)
    *  - Pin_SWDIO_1_INTR       (Second pin in the list)
    *  - ...
    *  - Pin_SWDIO_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Pin_SWDIO_SUT.c usage_Pin_SWDIO_SetInterruptMode
    *******************************************************************************/
    void Pin_SWDIO_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Pin_SWDIO_0_INTR) != 0u) 
		{ 
			 Pin_SWDIO_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Pin_SWDIO_SUT.c usage_Pin_SWDIO_ClearInterrupt
    *******************************************************************************/
