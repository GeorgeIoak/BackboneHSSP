...
*
* \funcusage
*  \snippet Pin_XRES_SUT.c usage_Pin_XRES_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_XRES_SUT.c usage_Pin_XRES_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_XRES_SUT.c usage_Pin_XRES_Read  
*******************************************************************************/
...
* preferred Pin_XRES_Read() API because the 
* Pin_XRES_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Pin_XRES_SUT.c usage_Pin_XRES_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Pin_XRES_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Pin_XRES_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Pin_XRES_0_INTR       (First pin in the list)
    *  - Pin_XRES_1_INTR       (Second pin in the list)
    *  - ...
    *  - Pin_XRES_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Pin_XRES_SUT.c usage_Pin_XRES_SetInterruptMode
    *******************************************************************************/
    void Pin_XRES_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Pin_XRES_0_INTR) != 0u) 
		{ 
			 Pin_XRES_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Pin_XRES_SUT.c usage_Pin_XRES_ClearInterrupt
    *******************************************************************************/
