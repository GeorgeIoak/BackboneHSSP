...
namespace HexFileParser
{
    ...
    public partial class FormHexFileParser : Form
    {
        ...
        internal const int BYTES_PER_FLASH_ROW = 64;
        ...
        internal const int HEX_FILE_LINES_PER_FLASH_ROW = 1;
        ...
        private void ParseFlashRowData()
        {
            ...
            for(int loop = 0; loop < HEX_FILE_LINES_PER_FLASH_ROW; loop++)
            {
                ...
                if (loop != (HEX_FILE_LINES_PER_FLASH_ROW - 1))
                {
                    m_swCfile.Write(", ");
                }
            }             
        ...
        private void WriteHeaderFile()
        {
            ...
            m_swHfile.WriteLine();
            m_swHfile.WriteLine("#define CY8C40xx_FAMILY                      1");
