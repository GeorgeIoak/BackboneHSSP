...
module top ;
	...
	wire [0:0] tmpOE__Pin_Power_net;
	wire [0:0] tmpFB_0__Pin_Power_net;
	wire [0:0] tmpIO_0__Pin_Power_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Power_net;
	electrical [0:0] tmpSIOVREF__Pin_Power_net;

	cy_psoc3_pins_v1_10
		#(.id("340e5a92-f438-41a3-bedc-72cb1d54c6a1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Power
		 (.oe(tmpOE__Pin_Power_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Power_net[0:0]}),
		  .io({tmpIO_0__Pin_Power_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Power_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Power_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Power_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpIO_0__LED_R_GND_net;
	wire [0:0] tmpINTERRUPT_0__LED_R_GND_net;
	electrical [0:0] tmpSIOVREF__LED_R_GND_net;

	cy_psoc3_pins_v1_10
		#(.id("d8573a58-b950-4456-a9ea-5c54b46b0b52"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_R_GND
		 (.oe(tmpOE__LED_R_GND_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_R_GND_net[0:0]}),
		  .io({tmpIO_0__LED_R_GND_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_R_GND_net),
		  .interrupt({tmpINTERRUPT_0__LED_R_GND_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_R_GND_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
