...
void    Pin_SWDCK_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Pin_SWDCK_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Pin_SWDCK__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Pin_SWDCK_SetInterruptMode() function.
     *  @{
     */
        #define Pin_SWDCK_INTR_NONE      (uint16)(0x0000u)
        #define Pin_SWDCK_INTR_RISING    (uint16)(0x0001u)
        #define Pin_SWDCK_INTR_FALLING   (uint16)(0x0002u)
        #define Pin_SWDCK_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Pin_SWDCK_INTR_MASK      (0x01u) 
#endif /* (Pin_SWDCK__INTSTAT) */
...
/* SIO registers */
#if defined(Pin_SWDCK__SIO_CFG)
    #define Pin_SWDCK_SIO_HYST_EN        (* (reg8 *) Pin_SWDCK__SIO_HYST_EN)
    #define Pin_SWDCK_SIO_REG_HIFREQ     (* (reg8 *) Pin_SWDCK__SIO_REG_HIFREQ)
    #define Pin_SWDCK_SIO_CFG            (* (reg8 *) Pin_SWDCK__SIO_CFG)
    #define Pin_SWDCK_SIO_DIFF           (* (reg8 *) Pin_SWDCK__SIO_DIFF)
#endif /* (Pin_SWDCK__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Pin_SWDCK_0_INTTYPE_REG 		(* (reg8 *) Pin_SWDCK__0__INTTYPE)
#endif /* (Pin_SWDCK__INTSTAT) */
